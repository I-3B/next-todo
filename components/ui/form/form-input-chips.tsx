import type { InputChipMode, InputChipOptions, InputChipValue, InputChipsProps } from '../input-chips'
...
export function FormInputChips<
  ...
  TOptions extends InputChipOptions<TOptionValue>,
  TValue extends InputChipValue<TOptionValue, TMode, TOptions>,
>({ InputChipsProps, onChangeEffect, mode, options, inputClassName, ...props }: FormInputChipsProps<TOptionValue, TMode, TOptions, TValue>) {
  return (
    <FormFieldItem {...props}>
      {({ onChange, value }) => (
        <InputChips
